...
urlpatterns = [
    ...
    path('ajax/edit/section',views.editSection,name="edit_section"),    
    path('ajax/delete/section',views.deleteSection,name="delete_section"),    
    path('ajax/delete/area',views.deleteArea,name="delete_area"),    
